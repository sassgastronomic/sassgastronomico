...
import {
  crearZona,
  type CampoNuevaZona,
  type EstadoNuevaZona,
} from "./actions";

const ESTADO_INICIAL: EstadoNuevaZona = {};
...
export function FormularioNuevaZona() {
  const [estado, accion, pendiente] = useActionState(crearZona, ESTADO_INICIAL);
  ...
  useEffect(() => {
    ...
    const refs: Record<CampoNuevaZona, React.RefObject<HTMLInputElement | null>> = {
      nombre: refNombre,
    };
